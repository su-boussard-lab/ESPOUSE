...
def run_all_metrics(covariate_summary_csv='./plp-covariate/allCovariateSummary-porpoise.csv', output_dir='./plp-covariate/evaluation',
                          fs_file_name='fs-all'):
...
def run_feature_selection(covariate_summary_csv='./plp-covariate/allCovariateSummary-porpoise.csv', metric_name='chi2', output_dir='./plp-covariate/fs', fs_file_name='fs-chi2-min7'):
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)
